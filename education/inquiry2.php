...
/*
function mail_it($content, $subject, $email, $sks) {
        mail($sks, $subject, $content, "From: $email\r\nReply-To: $email\r\nX-Mailer: DT_formmail");
}
*/
...
if ($env_report) {
   ...
   $env_reports = explode(",",$env_report);
   $content .= "\n------ 참고 : 보낸사람의 컴퓨터 환경------\n";
...
//$subject = iconv("EUC-KR", "UTF-8", $subject);
  ...
  include "../email/_email_inquriy2.html";
...
if ($redirect) {
 ...
 echo "<meta http-equiv='refresh' content='0;url=education14.html'>";
/*     
             echo " <table width='560' border='0' align='center' cellpadding='15' cellspacing='0'>
                    <tr> 
                      <td align='center' valign='top' bgcolor='E3EFB9'> <b><img src='img/join_img.jpg' width='499' height='298'></b><br> 
                        <table width='100' height='35' border='0' align='center' cellpadding='0' cellspacing='0'>
                          <tr align='center'> 
                            <td valign='bottom'><a href='/'><img src='img/confirm.gif' width='83' height='26' border=0></a></td>
                          </tr>
                        </table></td>
                    </tr>
                  </table>";
