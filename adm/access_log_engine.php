...
$filter = 'medium==organic || medium==(none)';
...
$ga->requestReportData(ga_profile_id,array('source'),array('visits','pageviews','newvisits','timeOnSite','exits'),'-visits',$filter,$start_date,$end_date,$start_index,$max_results); 
...
$category_data .= "<category name='$ssource'  hoverText='$ssource' />"; 
   ...
   if($total_count>0) {
   $graph_data .= "<set name='$s_source' value='$s_visits' color='$coloruid' />"; 
...
<tr>  <td  colspan=2 bgcolor='f4f2f2' class='bbs'><b>검색엔진별 방문통계   :<? echo "$start_date ~ $end_date";?></b>
</tr>
 <tr>
...
<table width='98%' border='0' cellpadding='3' cellspacing='1' bgcolor='cccccc' align="center">
                  <tr>
  <td bgcolor='f4f2f2' class='bbs' align=center>검색엔진</td>
