...
$fp = fopen("./class/shopacc_referer.xml", "w+");
...
<tr>  <td  colspan=2 bgcolor='f4f2f2' class='bbs'><b>도메인별 방문통계  :<? echo "$start_date ~ $end_date";?></b>
</tr>
 <tr>
  ...
  <tr> 
    <td valign="top" class="text" align="center"> <div id="chartdiv" align="center"> </div>
      <script type="text/javascript">
		   ...
		   chart.setDataURL("./class/shopacc_referer.xml");		   
...
<table width='98%' border='0' cellpadding='3' cellspacing='1' bgcolor='cccccc' align="center">
                  <tr>
  <td bgcolor='f4f2f2' class='bbs' align=center>도메인</td>
...
$ssource = "<a href='http://$ssource' target='_blank'>$ssource</a>";
