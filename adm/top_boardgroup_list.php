...
var list_update_php = "./top_boardgroup_list_update.php";
</script>
...
<tr class='bgcol1 bold col1 ht center'>
    ...
    <td>접근사용</td>
    <td>접근회원수</td>
    <td><? if ($is_admin == "super") { echo "<a href='./top_boardgroup_form.php'><img src='$g4[admin_path]/img/icon_insert.gif' border=0 title='생성'></a>"; } ?></td>
</tr>
...
for ($i=0; $row=sql_fetch_array($result); $i++) 
{
    ...
    $s_upd = "<a href='./top_boardgroup_form.php?$qstr&w=u&gr_id=$row[gr_id]'><img src='img/icon_modify.gif' border=0 title='수정'></a>";
    $s_del = "";
    if ($is_admin == "super") {
        //$s_del = "<a href=\"javascript:del('./top_boardgroup_delete.php?$qstr&gr_id=$row[gr_id]');\"><img src='img/icon_delete.gif' border=0 title='삭제'></a>";
        $s_del = "<a href=\"javascript:post_delete('top_boardgroup_delete.php', '$row[gr_id]');\"><img src='img/icon_delete.gif' border=0 title='삭제'></a>";
    }
    ...
    echo "<td><input type=text name=gr_10[$i] value='$row[gr_10]' size=2></td>";
