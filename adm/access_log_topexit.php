...
$ga->requestReportData(ga_profile_id,array('exitPagePath'),array('visits','pageviews','newvisits','entrances','exits'),'-exits',$filter,$start_date,$end_date,$start_index,$max_results); 
...
$ssource = $result->getExitPagePath();
...
<tr>  <td  colspan=2 bgcolor='f4f2f2' class='bbs'><b>종료된 페이지별 방문통계  :<? echo "$start_date ~ $end_date";?></b>
</tr>
 <tr>
  ...
  <tr> 
    <td valign="top" class="text" align="center"> <div id="chartdiv" align="center"> </div>
      <script type="text/javascript">
		   ...
		   chart.setDataURL("./class/shopacc_topexit.xml");		   
