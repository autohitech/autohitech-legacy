...
$ga->requestReportData(ga_profile_id,array('operatingSystem','operatingSystemVersion'),array('visits','pageviews','newvisits','timeOnSite','exits'),'-visits',$filter,$start_date,$end_date,$start_index,$max_results); 
...
$ssource = $result->getOperatingSystem()." ".$result->getOperatingSystemVersion();
