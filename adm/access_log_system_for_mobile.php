...
$filter = 'isMobile == Yes && operatingSystem == iPhone || operatingSystem == iPod || operatingSystem == iPad || operatingSystem == iPad2 || operatingSystem ==BlackBerry || operatingSystem ==Windows  || operatingSystem ==SymbianOS  || operatingSystem == Android';
...
$ga->requestReportData(ga_profile_id,array('operatingSystem','operatingSystem'),array('visits','pageviews','newvisits','timeOnSite','exits'),'-visits',$filter,$start_date,$end_date,$start_index,$max_results); 
...
$ssource = system_msg($result->getOperatingSystem());
...
<tr>  <td  colspan=2 bgcolor='f4f2f2' class='bbs'><b>운영체제별 방문통계   :<? echo "$start_date ~ $end_date";?></b>
</tr>
 <tr>
  ...
  <tr> 
    <td valign="top" class="text" align="center"> <div id="chartdiv" align="center"> </div>
      <script type="text/javascript">
		   ...
		   chart.setDataURL("./class/shopacc_system.xml");		   
...
<table width='98%' border='0' cellpadding='3' cellspacing='1' bgcolor='cccccc' align="center">
                  <tr>
  <td bgcolor='f4f2f2' class='bbs' align=center>운영체제</td>
