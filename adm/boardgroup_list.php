...
for ($i=0; $row=sql_fetch_array($result); $i++) 
{
    ...
    echo "<td><input type=text class=ed name=gr_subject[$i] value='".get_text($row[gr_subject])."' size=20></td>";

    if ($is_admin == "super")
        //echo "<td>".get_member_id_select("gr_admin[$i]", 9, $row[gr_admin])."</td>";
        echo "<td><input type=text class=ed name=gr_admin[$i] value='$row[gr_admin]'  size=10 maxlength=20></td>";
    else
