...
<tr>
    <td align=left><b>
    * 회원가입시 회원등급:권한2 / 직원게시판 사용 회원등급:권한8 / 팝업창 사용 회원등급: 권한9<br>
    * 홈페이지 전체를 관리할 수 있는 회원등급은 권한10입니다.</b>  
    </td>
</tr>
</table>
...
* 회원자료 삭제시 다른 회원이 기존 회원아이디를 사용하지 못하도록 회원아이디, 이름, 별명은 삭제하지 않고 영구 보관합니다.<br>
* 탈퇴회원 복구시는 회원정보수정을 클릭하신 다음 회원 정보중 탈퇴일자를 삭제하시면 복구됩니다. 
