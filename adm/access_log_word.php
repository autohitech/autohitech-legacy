...
<tr>  <td  colspan=2 bgcolor='f4f2f2' class='bbs'><b>검색어별 방문통계   :<? echo "$start_date ~ $end_date";?></b>
</tr>
 <tr>
...
<table width='98%' border='0' cellpadding='3' cellspacing='1' bgcolor='cccccc' align="center">
                  <tr>
  <td bgcolor='f4f2f2' class='bbs' align=center>검색어</td>
...
?>
<tr>
  <td bgcolor='ffffff' align=left style='padding-left:20px'><?php echo $sKey;?></td>
