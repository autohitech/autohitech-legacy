...
<tr class='ht'>
    ...
    <td>
        ...
        <option value='wr_1 desc'>문서형 메뉴 : 오름차순
        <option value='wr_1 asc'>문서형 메뉴 : 내림차순
        </select>
...
<tr class='ht'>
    ...
    <td>상단 파일 경로</td>
    <td><input type=text class=ed name=bo_include_head style='width:50%;' value='<?=$board[bo_include_head]?>'>../head.php</td>
</tr>
<tr class='ht'>
    <td><input type=checkbox name=chk_include_tail value=1></td>
    <td>하단 파일 경로</td>
    <td><input type=text class=ed name=bo_include_tail style='width:50%;' value='<?=$board[bo_include_tail]?>'>../tail.php</td>
</tr>
...
<tr class='ht'>
    ...
    <td>전체 검색 순서</td>
    <td><input type=text class=ed name=bo_order_search size=5 value='<?=$board[bo_order_search]?>'> 숫자가 낮은 게시판 부터 검색 또는 메뉴출력순서 지정</td>
</tr>
<tr class='ht'>
    <td><input type=checkbox name=chk_order_search value=1></td>
    <td>문서형페이지</td>
    <td>        <input type=checkbox name=bo_10 value='yes' <?=$board[bo_10]?'checked':'';?>>사용 
        <?=help("사용에 체크하시면 이 게시판에 속한 제목을 메뉴로 사용하여 한페이지씩 출력")?></td>
</tr>
<tr><td colspan=3 class='line2'></td></tr>
