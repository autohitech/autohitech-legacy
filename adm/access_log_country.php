...
$ga->requestReportData(ga_profile_id,array('country'),array('visits','pageviews','newvisits','timeOnSite','exits'),'-visits',$filter,$start_date,$end_date,$start_index,$max_results); 
...
$s_source = country_msg($result->getCountry());
if($s_source =="") {
$ssource = $result->getCountry();
} else {
$ssource = $s_source;
}
...
<tr>  <td  colspan=2 bgcolor='f4f2f2' class='bbs'><b>국가별 방문통계  :<? echo "$start_date ~ $end_date";?></b>
</tr>
 <tr>
...
<table width='98%' border='0' cellpadding='3' cellspacing='1' bgcolor='cccccc' align="center">
                  <tr>
  <td bgcolor='f4f2f2' class='bbs' align=center>국가</td>
