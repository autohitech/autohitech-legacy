...
exec('/usr/local/bin/ffmpeg -i /www/gcs/www/ucc/tmp_uccfile/133635679414.mov -s 500x500 /www/gcs/www/ucc/tmp_uccfile/133635679414.flv');
*/
...
$this->Output("<span id=\"status\" style=\"display:none;\"><div id=step_3_txt><div id=\"progressbar\" style=\"width: 428px; height: 30px;\"><span id=\"percent\" class=\"label2\">0%</span></div></div><div id=step_4_txt>총 <span id=\"time_total\">?</span> {lang[LANG][5]} <span class=\"text\" id=\"time_cur\">?</span> {lang[LANG][6]} </div>", $pkey, 'html');
}
