...
ini_set('error_log', '/var/www/html/data/log/php_error.log');
...
if (!is_dir($g4['session_path'])) {
    @mkdir($g4['session_path'], 0707);
    @chmod($g4['session_path'], 0707);
}
@session_save_path(realpath($g4['session_path']));
