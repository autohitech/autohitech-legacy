...
.n_title2 { font-family:돋움; font-size:9pt; color:#5E5E5E; }
	...
	<table width="100%" height="30" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
         <tr>
            <td align="left" valign="top"><table height="20" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="20" align="left" valign="top"><img src="<?=$g4['bbs_img_path'];?>/title_icon01.gif" /></td>
                  <td align="left" valign="top"><span class="navi_title"> 최근 게시물</span></td>
                  <td width="225" align="left" valign="top"><img src="<?=$g4['bbs_img_path'];?>/title_text01.gif" /></td>
                </tr>
            </table></td>
            <td align="right" valign="middle"><img src="<?=$g4['bbs_img_path'];?>/navi_home.gif" align="absmiddle" /><span class="navi_t01">최근 게시물</span>
</td>
          </tr>
        </table>
<!-- 분류 시작 -->
