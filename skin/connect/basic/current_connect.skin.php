         ...
         <tr>
            <td align="left" valign="top"><table height="20" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td align="left" valign="top"><span class="navi_title"> 현재접속자</span></td>
                  <td width="225" align="left" valign="top"><img src="<?=$g4['bbs_img_path'];?>/title_text01.gif" /></td>
                </tr>
            </table></td>
            <td align="right" valign="middle"><img src="<?=$g4['bbs_img_path'];?>/navi_home.gif" align="absmiddle" /><span class="navi_t01">현재접속자</span>
</td>
          </tr>
        </table>
