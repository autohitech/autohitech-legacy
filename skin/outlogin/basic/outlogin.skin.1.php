...
win_password_lost('./password_lost.php');
<table width="220" border="0" cellpadding="0" cellspacing="0">
 ...
 <td height="25" colspan="2" align="left" valign="top"><img src="<?=$outlogin_skin_path?>/img/login_title02.gif" /></td>
            ...
            <tr>
              ...
              <td width="210" align="left" valign="middle"><table width="210" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="100" align="left" valign="middle"><input name="mb_id" tabindex=1 type="text" class="login_t01" style="border : 1px solid #d4d4d4; width: 100px; HEIGHT: 18px; BACKGROUND-COLOR: #f4f4f4" value="아이디" onmouseover='chkReset(this.form);' onfocus='chkReset(this.form);' /></td>
                  <td width="65" align="right" valign="middle" style="padding-right:3;"><input type="checkbox" border="0" name="auto_login" value="1" onclick="if (this.checked) { if (confirm('자동로그인을 사용하시면 다음부터 회원아이디와 패스워드를 입력하실 필요가 없습니다.\n\n\공공장소에서는 개인정보가 유출될 수 있으니 사용을 자제하여 주십시오.\n\n자동로그인을 사용하시겠습니까?')) { this.checked = true; } else { this.checked = false; } }" /> <img src="<?=$outlogin_skin_path?>/img/img_save01.gif" align="absmiddle" /></td>
                </tr>
               <tr>
    ...
    <td align="left" valign="middle"><table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tr>
        <td align="left" valign="bottom"><a href="<?=$g4[bbs_path]?>/register.php" class="login">튜닝 회원가입</a> <span class="login_line">|</span> <a href="javascript:win_password_lost();"class="login">회원 아이디/비밀번호찾기</a></td>
      </tr>
    </table></td>
            </tr>
  <tr>
