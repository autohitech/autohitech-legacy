 ...
 <td height="25" colspan="2" align="left" valign="top"><img src="<?=$outlogin_skin_path?>/img/login_title02.gif" /></td>
	...
	<form name="fhead" method="post" action="javascript:fhead_submit(document.fhead);" autocomplete="off" style="display:inline;">
			...
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				<tr>
					<td height="50" align="center" valign="middle"><img src="<?=$outlogin_skin_path?>/img/admin_img.gif" align="absmiddle"/><font color="00928e"><b><u><?=$member[mb_name];?></u></b></font> <span class="login_t01">님 환영합니다.</span><? if ($is_admin == "super" || $is_auth) { ?><br />
<a href="<?=$g4['admin_path']?>/" class="login">[관리자페이지바로가기]</a><? } ?></th>				</tr>
				<tr>
  ...
  <tr>
    <td align="left" valign="top"></td>
              <td width="211" height="1" align="left" valign="middle" bgcolor="dcdcdc"></td>
  </tr>
            
  <tr>
    <td width="10" height="28"></td>
    <td align="left" valign="middle"><a href="javascript:win_scrap();" class="login">스크랩북</a> <span class="login_line">|</span> <a href="<?=$g4['bbs_path']?>/member_confirm.php?url=register_form.php" class="login">정보수정</a> <span class="login_line">|</span> <a href="<?=$g4['bbs_path']?>/logout.php" class="login">로그아웃</a> <span class="login_line">|</span> <a href="javascript:memberLeave();" target="" class="login">회원탈퇴</a></td>
  </tr>
  <tr>
              <td align="left" valign="top"></td>
              <td height="1" align="left" valign="middle" bgcolor="dcdcdc"></td>
  </tr>
