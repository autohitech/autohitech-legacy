...
<tr><td height=2 bgcolor=#4d4f53></td></tr>
<tr>
    <td height=28 background="<?=$board_skin_path?>/img/view_dot.gif" style="color:#aaa; padding:7px 0px 7px 3px; background:#f8f8f8;">
...
?>
<tr> 
    <td style="word-break:break-all; padding-top:35px;">
        <? 
        // 파일 출력
        for ($i=0; $i<=count($view[file]); $i++) {
            if ($view[file][$i][view]) 
