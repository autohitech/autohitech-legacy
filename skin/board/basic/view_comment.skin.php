...
<textarea id="wr_content" name="wr_content" rows="5" itemname="내용" required <? if ($comment_min || $comment_max) { ?>onkeyup="check_byte('wr_content', 'char_count');"<? }?> style="width:100%; height:75px; background:#f0f0f0; border:1px solid #e5e5e5;"></textarea>
