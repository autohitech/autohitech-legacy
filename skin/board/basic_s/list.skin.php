...
<table width="<?=$width?>" align="center" cellpadding="0" cellspacing="0"><tr><td>
    ...
    <tr bgcolor="f46553" height="25">
        <th align="center" class="customer_t01">번호</th>
        <? if ($is_checkbox) { ?><th align="center"><input onclick="if (this.checked) all_checked(true); else all_checked(false);" type="checkbox"></th><?}?>
        <th align="center" class="customer_t01">제&nbsp;&nbsp;&nbsp;목</th>
        <th align="center" class="customer_t01">글쓴이</th>
        <th align="center"><?=subject_sort_link('wr_datetime', $qstr2, 1)?>날짜</a></th>
        <th align="center"><?=subject_sort_link('wr_hit', $qstr2, 1)?>조회</a></th>
        <? if ($is_good) { ?><th align="center"><?=subject_sort_link('wr_good', $qstr2, 1)?>추천</a></th>
        <?}?>
        <? if ($is_nogood) { ?><th align="center" class="customer_t01"><?=subject_sort_link('wr_nogood', $qstr2, 1)?>비추천</a></th>
        <?}?>
    </tr>
    ...
    <tr class="bg<?=$bg?>"> 
        ...
        <td align="center" class="name"><?=$list[$i][name]?></td>
        <td align="center" class="datetime"><?=$list[$i][datetime2]?></td>
        <td align="center" class="hit"><?=$list[$i][wr_hit]?></td>
        <? if ($is_good) { ?><td align="center" class="good"><?=$list[$i][wr_good]?></td>
        <? } ?>
        <? if ($is_nogood) { ?><td align="center" class="nogood"><?=$list[$i][wr_nogood]?></td>
        <? } ?>
    </tr>
    <? } // end for ?>
