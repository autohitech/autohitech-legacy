...
<table width="<?=$width?>" height="30" border=0 align="center" cellpadding="0" cellspacing="0">
  <tr>
       <td width="20%">&nbsp;</td>
	...
	<td width="20%" align="right" valign="bottom" style="padding-bottom:5;">
<?
...
<table width="<?=$width?>" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td height="4" align="left" valign="top" background="<?=$board_skin_path?>/img/table_line_P.gif"></td>
                </tr>
</table>
<table width=<?=$width?> border=0 align="center" cellpadding=1 cellspacing=1 bgcolor="e3e3e3">
    <tr class=size2 height=30>     
	<td align=center valign="middle" bgcolor="#f0f0f0" class="sc_sun"><b>SUN</b></td>     
	<td align=center valign="middle" bgcolor="#f0f0f0" class="sc_day"><b>MON</b></td>     
	<td align=center valign="middle" bgcolor="#f0f0f0" class="sc_day"><b>TUE</b></td>     
	<td align=center valign="middle" bgcolor="#f0f0f0" class="sc_day"><b>WED</b></td>     
	<td align=center valign="middle" bgcolor="#f0f0f0" class="sc_day"><b>THU</b></td>     
	<td align=center valign="middle" bgcolor="#f0f0f0" class="sc_day"><b>FRI</b></td>     
	<td align=center valign="middle" bgcolor="#f0f0f0" class="sc_sat"><b>SAT</b></td>
    </tr>
<?
$cday = 1;
