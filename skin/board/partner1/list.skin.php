...
<table width="<?=$width?>" align="center" cellpadding="0" cellspacing="0"><tr><td>
    ...
    <tr bgcolor="f46553" height="25">
        ...
        <th align="center" class="customer_t01">납품처</th>
        <th align="center" class="customer_t01">적용시스템</th>
    ...
    <tr class="bg<?=$bg?>"> 
        ...
        <td class="content">
            ...
            if ($list[$i][is_notice])
                echo "<a href='{$list[$i][href]}'><span class='notice'>{$list[$i][content]}</span></a>";
            else
                echo "<a href='{$list[$i][href]}'>{$list[$i][content]}</a>";
    ...
    <div class="board_search">
        ...
        <select name="sfl">
            <option value="wr_subject">납품처</option>
            <option value="wr_content">적용시스템</option>
            <option value="wr_subject||wr_content">납품처+적용시스템</option>
        </select>
