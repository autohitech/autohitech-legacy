...
<?
 ...
 $result=mysql_query("select * from zetyx_board_auto_note order by no desc limit 4");
 ...
 while($data=mysql_fetch_array($result)) {
  ...
  $date=date("Y/m/d",$data[reg_date]);
            echo "<tr>
                  ...
                  <td width='279' height='20'><a href='./board/view.php?id=auto_note&no=$no'>[$date] $subject</a> </td>
                </tr>";
